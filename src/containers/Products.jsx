  ...
  return (
    <div className="products-container">
      <div className="card">
        ...
        <p>
          Easily log your expenses in real - time, categorize transactions, and
      ...
      <div className="card">
        ...
        <p>
          Generate detailed reports and visualizations to analyze your financial
      ...
      <div className="card">
        ...
        <p>
          ...
          industry-standard encryption and security protocols to keep your data
          safe.
        </p>
      </div>
    </div>
